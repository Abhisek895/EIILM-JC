  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-24 lg:bottom-6 right-5 sm:right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-r from-primary-600 to-primary-500 text-white shadow-2xl transition-transform hover:scale-110 active:scale-95"
      ...
      {isOpen && (
        <div className="fixed bottom-28 lg:bottom-24 right-4 sm:right-6 z-50 flex h-[500px] max-h-[72vh] w-[calc(100vw-2rem)] sm:w-96 flex-col overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-2xl">
