...
const DATA_SET_A: AnalyticsData = {
  kpiCards: [
    { label: 'Total Enrolled Students', value: '5,240', trend: '+14% from last term', isPositive: true, icon: '🎓', color: 'from-blue-500 to-indigo-600' },
    { label: 'Admission Conversion Rate', value: '24.2%', trend: '+3.5% this month', isPositive: true, icon: '🎯', color: 'from-emerald-400 to-teal-500' },
    { label: 'Monthly Website Traffic', value: '45,820', trend: '+28% brand reach', isPositive: true, icon: '⚡', color: 'from-sky-400 to-blue-500' },
  ...
  funnelSteps: [
    { stepName: 'Total Leads Received', count: 1240, percentage: 100, color: 'bg-blue-600' },
...
const DATA_SET_B: AnalyticsData = {
  kpiCards: [
    { label: 'Total Enrolled Students', value: '5,310', trend: '+18% term-on-term', isPositive: true, icon: '🎓', color: 'from-blue-500 to-indigo-600' },
    { label: 'Admission Conversion Rate', value: '26.8%', trend: '+5.1% this week', isPositive: true, icon: '🎯', color: 'from-emerald-400 to-teal-500' },
    { label: 'Monthly Website Traffic', value: '49,200', trend: '+35% tech summit impact', isPositive: true, icon: '⚡', color: 'from-sky-400 to-blue-500' },
  ...
  funnelSteps: [
    { stepName: 'Total Leads Received', count: 1350, percentage: 100, color: 'bg-blue-600' },
      ...
      <div className="space-y-6 max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 border border-transparent rounded-xl transition-all font-semibold shadow-md text-sm"
          >
                ...
                {data.courses.map((course, i) => (
                  <div key={i} className="flex items-center justify-between p-3.5 bg-gray-50/50 rounded-xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                    ...
                    <div className="text-right">
                      ...
                      <span className="block text-[10px] font-bold text-blue-600 mt-0.5">{course.percentage}% share</span>
                    </div>
                  </div>
                ))}
              </div>
