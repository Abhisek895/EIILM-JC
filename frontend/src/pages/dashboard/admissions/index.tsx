    ...
    <DashboardLayout>
      <div className="space-y-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { label: 'Total Inquiries', value: stats.total, color: 'from-blue-500 to-indigo-600', icon: '📞' },
            { label: 'New Leads', value: stats.new, color: 'from-sky-400 to-blue-500', icon: '✨' },
                    ...
                    <tr key={inq.id} className="hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <select
                          ...
                          className="text-xs font-semibold bg-white border border-gray-200 rounded-xl px-3 py-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all cursor-pointer"
                        >
