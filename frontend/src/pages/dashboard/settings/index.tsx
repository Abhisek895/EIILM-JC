...
const HOME_SETTINGS_FIELDS = [
  ...
  { key: 'stat_years', label: 'Proof: Years of Excellence', type: 'text', placeholder: '15+' },
  { key: 'stat_students', label: 'Proof: Students Enrolled', type: 'text', placeholder: '1,500+' },
  { key: 'stat_faculty', label: 'Proof: Faculty Members', type: 'text', placeholder: '45+' },
  { key: 'stat_courses', label: 'Proof: Courses Offered', type: 'text', placeholder: '12+' },
