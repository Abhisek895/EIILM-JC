...
export default function DepartmentDetailPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .catch(() => {
        setError('Unable to load department/faculty. API unreachable.');
        setNotFound(true);
      })
    ...
    return (
      <MainLayout>
        <div className="container mx-auto px-6 py-20 text-center">
          ...
          <Link href="/departments" className="text-primary-600 hover:underline">
            ← Back to Departments
          </Link>
        </div>
      </MainLayout>
    ...
    <MainLayout>
      <div className="bg-gradient-to-r from-primary-700 to-indigo-700 text-white py-16">
        <div className="container mx-auto px-6">
          <Link href="/departments" className="text-primary-200 text-sm hover:text-white mb-3 inline-block">
            ← All Departments
          </Link>
              ...
              {faculty.map((f) => (
                ...
                >
                  ...
                  <div>
                    ...
                    {f.designation && (
                      <p className="text-primary-600 text-sm">{f.designation}</p>
                    )}
                    {f.qualification && (
