      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Excellence in Education Management. Complete college operations platform for admissions,
          ...
          {[
            {
              ...
              desc: 'Manage courses, departments, faculty, and syllabus.',
            },
            {
              title: 'Admission and CRM',
              desc: 'Handle student inquiries, applications, and enrollment.',
            },
            {
              title: 'Dynamic CMS',
