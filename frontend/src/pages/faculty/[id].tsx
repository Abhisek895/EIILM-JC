...
export default function FacultyDetailPage() {
    ...
    return (
      <MainLayout>
        <div className="container mx-auto px-6 py-20 text-center">
          ...
          <Link href="/faculty" className="text-primary-600 hover:underline mt-4 inline-block">
            ← Back to Faculty
          </Link>
        </div>
      </MainLayout>
  ...
  return (
    <MainLayout>
      <div className="bg-gradient-to-r from-primary-700 to-indigo-700 text-white py-16">
        <div className="container mx-auto px-6">
          <Link href="/faculty" className="text-primary-200 text-sm hover:text-white mb-3 inline-block">
            ← All Faculty
          </Link>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-md overflow-hidden">
            <div className="flex flex-col md:flex-row">
              ...
              <div className="p-8 flex-1">
                ...
                {faculty.designation && (
                  <p className="text-primary-600 font-semibold text-lg mb-2">{faculty.designation}</p>
                )}
                {faculty.department && (
                  <Link
                    href={faculty.department.slug ? `/departments/${faculty.department.slug}` : '#'}
                    className="inline-block bg-primary-50 text-primary-600 text-sm px-3 py-1 rounded-full mb-4 hover:bg-primary-100"
                  >
