...
export default function FacultyPage() {
  ...
  const load = async (deptId?: number) => {
    ...
    try {
      ...
      setError('Unable to load faculty. API unreachable.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <MainLayout>
      <HeroSlider 
        ...
        fallbackSubheading={siteSettings.faculty_hero_subheading || 'Meet our distinguished team of educators, researchers, and industry experts.'}
      />
            ...
            {faculty.map((f) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  {f.department && (
                    <span className="inline-block mt-2 bg-primary-50 text-primary-600 text-xs px-2 py-0.5 rounded-full">
                      {f.department.name}
                    </span>
                  )}
                </div>
